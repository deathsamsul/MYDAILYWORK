...
from schema import data_preprocessing
...
with st.expander("About me"):
    st.write("Hi,i am samsul" \
    " Machine Learning , Deep Learning ,NLP & Gen AI Enthusiast ")
...
# load fine tunied distillbert-base-uncased-finetuned-sst-2-english model
# @st.cache_resource
# def load_deberta_model():
#     model=AutoModelForSequenceClassification.from_pretrained(
#         "movie_genre_prediction/distilbart/deberta_movie_genre_model_gpu_v1"
#         )
#     tokenizer=AutoTokenizer.from_pretrained(
#         'movie_genre_prediction/distilbart/deberta_movie_genre_model_gpu_v1'
#     )
#     with open(
#         r"movie_genre_prediction/distilbart/label_encoder_movie_genre_model_gpu_v1.pkl","rb") as f:        
...
@st.cache_resource
def load_deberta_model():
    model_path = os.path.join(BASE_DIR, "..", "distilbart", "deberta_movie_genre_model_gpu_v1")
    label_path = os.path.join(BASE_DIR, "..", "distilbart", "label_encoder_movie_genre_model_gpu_v1.pkl")
...
def load_tfidf_model():
    with open(r"movie_genre_prediction/TFID_vector/movie_27_genre_classifier.pkl", "rb") as f:

        model = pickle.load(f)
    with open(r"movie_genre_prediction/TFID_vector/label_encoder.pkl", "rb") as f:
        label_encoder = pickle.load(f)
